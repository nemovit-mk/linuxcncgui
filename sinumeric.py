...
#    Sinumeric a GUI for linuxcnc cnc controller 
#    Maksum Kotelnikov copyright 2017
#
...
"""
# Sinumeric is made for running linuxcnc CNC machines
# Sinumeric is folk from Gscreen and is made for simulation of proffesional lathe
# Sinumeric was built with touchscreens in mind though a mouse works too.
# Sinumeric is, at it's heart, a gladevcp program though loaded in a non standard way.
"""
import sys,os,subprocess
def _print_help():
            print """ Sinumeric is a operator screen for linuxcnc based on pyGTK / GLADE.\n
        It is usually loaded from linuxcnc's INI file under the [DISPLAY] HEADER
        eg. DISPLAY = /path to Sinumeric\n
        Options:
...
def excepthook(exc_type, exc_obj, exc_tb):
    ...
    if excepthook_msg_ct < 1:
        m = gtk.MessageDialog(w,
                ...
                ("Sinumeric encountered an error.  The following "
