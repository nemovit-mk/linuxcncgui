...
class Gfile():
    def __init__(self, path, box_widget, key):
        ...
        print ("Create G reader %r"% path, box_widget)
        self.key = key
        self.filename = path
        ...
        self.widget["mdi_header1"].get_parent().modify_bg(gtk.STATE_NORMAL, self.colors.blue)
        self.widget["mdi_header2"].get_parent().modify_bg(gtk.STATE_NORMAL, self.colors.blue)
...
#        self.scroll_to = 5.0
#        print("lbls before to %r"% self.crnt_lbl_nmbr, self.list.index(self.up_lbl), self.list.index(self.dwn_lbl),self.lbls_nmbr)
        if self.crnt_lbl_nmbr < self.list.index(self.up_lbl):
            scroll_to = (adj.upper-adj.lower)*(float(self.crnt_lbl_nmbr)/self.lbls_nmbr)
            ...
            scroll_to = (adj.upper-adj.lower)*(float(self.crnt_lbl_nmbr+1)/self.lbls_nmbr)-adj.page_size
...
#        print("calc %r"% (int((adj.upper-adj.lower)*(float(self.crnt_lbl_nmbr+1)/self.lbls_nmbr))))
#        print("scroll to %r"% self.scroll_to)
#        print("lower to %r"% adj.lower)
#        print("upper to %r"% adj.upper)
#        print("page size to %r"% adj.page_size)
#        print("lbls to %r"% self.crnt_lbl_nmbr, self.list.index(self.up_lbl), self.list.index(self.dwn_lbl),self.lbls_nmbr)
